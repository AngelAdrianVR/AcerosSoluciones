<template>
    <main class="rounded-2xl border-2 border-[#D9D9D9] p-4 h-72 relative group">
        <!-- Botones de acción -->
        <div v-if="$page.props.auth?.user?.id" class="absolute top-2 right-2 flex items-center justify-end space-x-2 opacity-0 group-hover:opacity-100 group-hover:translate-y-2 transition-all duration-300 ease-out">
