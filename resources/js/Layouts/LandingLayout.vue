        ...
        <div class="min-h-screen">
                ...
                <div class="max-w-full sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex justify-between items-center space-x-4 w-full mr-16">
                            ...
                            <!-- buscador -->
                            <div>
                                <el-input v-model="search" placeholder="¿Qué estás buscando?" class="!w-52 md:!w-96">
                                    <template #prefix>
                                        <div>
                                            <i
                                                class="fa-solid fa-magnifying-glass pr-3 py-1 border-r-2 border-gray-300"></i>
                                        </div>
                                    </template>
                                </el-input>
                            </div>
            ...
            <footer class="bg-[#121212] text-white">
                ...
                <section class="mx-16 pt-6 flex items-center justify-between text-sm">
                    <span>&COPY; 2024. ACEROS SOLUCIONES</span>
